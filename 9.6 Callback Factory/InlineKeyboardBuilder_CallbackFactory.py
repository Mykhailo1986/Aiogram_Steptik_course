...
# v3Ну, а если мы хотим поймать только нажатие на первую кнопку ("Категория 1"),
...
# V2 Этот хэндлер будет срабатывать на нажатие любой
...
# V1 Этот хэндлер будет срабатывать на нажатие любой
# инлайн-кнопки и распечатывать апдейт в терминал
@dp.callback_query()
